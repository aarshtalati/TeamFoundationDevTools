...
namespace TeamFoundationDevTools
{
    ...
    static class Preferences
    {
        ...
        internal static void PreferencesHome() { PreferencesHome(null); }

        internal static void PreferencesHome(PreferenceMenu? choice)
        {
            switch (choice)
            {
        ...
        // Syntactic sugar for optional parameter ( if yer usin' Vs 2k8 ! )
        static void ViewPreferences() { ViewPreferences(false); }

        static void ViewPreferences(bool displayOnly)
        {
